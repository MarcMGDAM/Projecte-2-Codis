...
public class Client {
    ...
    public String toString() {
        return "Client [cognoms=" + cognoms + ", compte_bancari=" + compte_bancari + ", comunicacio_comercial="
                + comunicacio_comercial + ", condicio_fisica=" + condicio_fisica + ", contrasenya=" + contrasenya
                + ", data_naix=" + data_naix + ", dni=" + dni + ", edat=" + edat + ", email=" + email + ", nom=" + nom
                + ", sexe=" + sexe + ", telefon=" + telefon + ", usuari=" + usuari + "]";
    }
    ...
    private void cargarDadesDelClient(PreparedStatement ps) throws SQLException {
    ...
    public void altaClient() throws SQLException {
        ...
        if (consultaClientBD(d.getDni()) != null) {
            ...
            do {
                dataCorrecta = true;
                System.out.println("Introdueix la seva data de naixement en el següent format (dd.mm.yyyy)");
                try {
            ...
            System.out.println("Introdueix la caontrasenya del teu usuari: ");
    ...
    public Client altaClientBD() throws SQLException {
        ...
        // Demanem el DNI
        String inserció = "INSERT INTO socis (DNI, nom, cognom, codi_categoria) value (?,?,?,?)";
        PreparedStatement ps = con.connexioBD.prepareStatement(inserció);

        ps.setString(1, this.dni.getDni());
        ps.setString(2, this.getNom());
        ps.setString(2, this.getCognoms());
    ...
    private void getSexe(String sexe) {
        this.sexe = sexe;
    }

    private void getCognoms(String cognoms) {
        this.cognoms = cognoms;
    }
