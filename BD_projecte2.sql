...
select * from socis;
select DNI, nom, cognom from socis order by cognom;
...
insert into reserva_lliure values(default,'1','60699248V','2012-12-10','17:00:00');
...
where R.ID = L.IDL and L.IDL = A.ID and R.DNI= '60699248V';

select * from socis order by cognom;
